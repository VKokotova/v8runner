...
Процедура ОбновитьКонфигурациюБазыДанныхИзХранилищаНаВерсию(СтрокаСоединения, ПользовательХранилища, ПарольХранилища="", НомерВерсии) Экспорт
	...
	ПараметрыСвязиСБазой.Добавить("/ConfigurationRepositoryUpdateCfg");
	ПараметрыСвязиСБазой.Добавить("-v """ + НомерВерсии + """");
	ПараметрыСвязиСБазой.Добавить("-force");
